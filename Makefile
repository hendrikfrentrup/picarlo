...
.PHONY: help uv-update sync install lint format typecheck test check build publish install-check precommit clean
...
clean: ## Remove build and cache artifacts
	rm -rf dist build .pytest_cache .ruff_cache .pyrefly_cache *.egg-info
